<template>
    <view class="container">
		...
		<view class="list-cell b-b" style="margin-top: 2upx" @click="navTo('/package/pages/chat/feedback')" hover-class="cell-hover"
		      :hover-stay-time="50">
        ...
        methods: {
            ...
            about(url) {
                uni.showModal({
                    showCancel: false,
                    title: '淇湘优购',
                    content: '淇湘优购是一个汇聚了全网隐藏优惠券的网购返利软件 ！这里汇聚淘宝、京东、天猫、拼多多等商城优惠券信息！每天实时更新优惠券，发放一些商家的大额优惠券！这里可以帮你网购省钱返利，也可以帮你兼职赚钱！每年最高能让你网购省50%的钱！\n\n西安淇湘优购网络科技有限公司',
                    success: (e) => {
                        if (e.confirm) {
