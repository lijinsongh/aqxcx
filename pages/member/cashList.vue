		...
		<view v-for="(item, index) in list" :key="index" class="item">
			<view>
				<view style="margin-bottom: 8upx;text-align: right;">
					<!-- <text style="color: #FF0000;margin-right: 32upx;font-size: 16px;font-weight: 600"> ￥{{item.money}}</text> -->
				...
				<view style="color: #999999;font-size: 28upx;">
					...
					<view style="margin-bottom: 8upx;text-align: right;">
						<!-- 提现金额： -->
						<text style="color: #FF0000;font-size: 32upx;font-weight: 600"> ￥{{item.money}}</text>
