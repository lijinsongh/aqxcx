<template>
	<view>
		<view style="position: absolute;width: 100%;height: 460upx;background: #FF0000;"></view>
		<view style="color: #FFFFFF;position: relative;padding-left: 80upx;padding-top: 80upx;">
			...
			<view @click="goMoney" style="background: #FFFFFF;color: #FF0000;padding-top: 16upx;padding-left: 32upx;padding-right: 32upx;border-radius: 32upx;margin-right: 8upx;">积分兑换</view>
			</view>
		</view>
