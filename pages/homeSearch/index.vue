<template>
	<view class="s-page-wrapper">
			...
			<view class="main-title">
				<view class="search-tab search_wrap">
					...
					<view class="search_wraps">
						...
						<input type="text" maxlength="-1" :value="keywords" @confirm="submitSearch"
							:placeholder="placeholder" class="search_area" style="color: #555555;"
							@input="searchInput" />
					</view>
		...
		<view class="search-cat">
			...
			<!-- 流程 -->
			<view class="line">
				<image src="https://taobaoshop.xianmxkj.com/search/copy.png"></image>
				<text>复制商品标题</text>
				<image style="width:56rpx;height:18rpx;" src="https://taobaoshop.xianmxkj.com/search/arr.png"></image>
				<image src="https://taobaoshop.xianmxkj.com/search/rsearch.png"></image>
				<text>粘贴搜索</text>
				<image style="width:56rpx;height:18rpx;" src="https://taobaoshop.xianmxkj.com/search/arr.png"></image>
				<image src="https://taobaoshop.xianmxkj.com/search/yh.png"></image>
				<text>领劵购买</text>
			</view>

			<view v-if="recentKeyword.length > 0">
				<view class="search-cat-tit">
					<view class="up-menu" style="font-size: 32upx;display: flex;">
						<view style="width: 70%;">搜索历史</view>
						<view style="width: 30%;text-align: end;">
							<view @tap="deleteKeyword" class="del_img"></view>
						</view>
					</view>
				</view>
								...
								if (res.data) {
									...
									if (this.$queue.getData('relation_id')) {
										if (res.data.type === 0) {
											...
											uni.navigateTo({
												url: '/package/pages/detail/wph?itemid=' + res.data.id
											});
										} else {
											uni.navigateTo({
...
<style>
	...
	.del_img {
		...
		height: 36rpx;
		display: inline-block;
		background: url(https://taobaoshop.xianmxkj.com/search/del.png);
