...
<style>
	...
	.dlbutton {
		...
		width:601upx;
		height:90upx;
		background: -moz-linear-gradient(left, #F15B6C, #FF0000 100%);
		background: -webkit-gradient(linear, left top, left right, color-stop(0, #F15B6C), color-stop(100%, #FF0000));
		background: -webkit-linear-gradient(left, #F15B6C 0, #FF0000 100%);
		background: -o-linear-gradient(left, #F15B6C 0, #FF0000 100%);
		background: -ms-linear-gradient(left, #F15B6C 0, #FF0000 100%);
		background: linear-gradient(to left, #F15B6C 0, #FF0000 100%);
