		...
		methods: {
			...
			async OnCanvas() {
				...
				if (_this.PriceTxt != '') {
					...
					_this.ctx.fillText('特惠价 ￥' + _this.PriceTxt, _strlineW, _strHeight); //商品价格
					_strlineW += _this.ctx.measureText('特惠价 ￥' + _this.PriceTxt).width + uni.upx2px(10);
				}
				// #ifdef H5
