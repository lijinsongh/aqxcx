	...
	<view>
		...
		<view class="navbar" style="position: fixed;z-index: 100;text-align: center;width: 100%;top: 80upx;">
			...
			<view class="navbar" style="position: fixed;z-index: 100;text-align: center;width: 100%;top: 0;">
				<!-- #endif -->
				<view v-for="(item, index) in tabList" :key="index" style="margin-left: 90upx;" @tap="fromTabSelect(index)">
					...
					<view class="goods-list" style="display: flex;flex-wrap: wrap;justify-content: space-between;"
						...
						<view @tap='goDetail(item.id)'
							...
							<view style="margin-top: 8upx;">
								<view
									style="padding:0 4upx;height: 80rpx;font-size: 28rpx;margin-right: 8rpx;margin-left: 8rpx;overflow: hidden;">
									<text
	...
	export default {
		...
		data() {
			return {
				...
				collectWPHKey: 'orange-sqx-footprint-wph',
				collectJdKey: 'orange-sqx-footprint-jd',
				collectZyKey: 'orange-sqx-footprint-zy',
