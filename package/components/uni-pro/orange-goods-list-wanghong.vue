		...
		<view class="content" style="padding: 16upx;">
			<view style="display: flex">
				<text class="twolist-hidden" style="height: 80upx;font-size: 28upx;margin-right: 4upx;margin-left: 4upx;width: 95%;max-lines:2;overflow: hidden">
					<text style="color: #FFFFFF;background: #FF2638;font-size: 24upx;padding-left: 12upx;padding-right: 12upx;border-radius: 6upx;margin-right: 8upx;padding-top: 4upx;padding-bottom: 4upx;">淇湘优购</text>
