	...
	<view style="background: white;padding:32upx;border-bottom: 1px solid #F6F6F6">
		...
		<view style="display: flex">
			...
			<view class="box-name">
				...
				<view style="width: 30%;text-align:center;border-radius: 16px;border: 1px solid #FF2638;color: #FF2638;padding: 1px 16upx 1px 16upx"
				 @click="copyHref()">
					已抢完
				</view>
			</view>
		...
		<view style="text-align: left;display: flex;margin-top: 8px;padding: 16upx;">
			<view>
				...
				<!-- <view style="color: #FF2638;margin-top: 4px" @click="copyHref()">#点击此处复制分享素材#</view> -->
			</view>
		</view>
