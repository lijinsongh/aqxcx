	...
	<view>
		<view @click="open(itemid)" class="itemInfo1" v-bind:key='itemid'>
			<view style="position: relative">
				<image :src="itempic" style="border-radius: 10upx;width: 330upx;" mode="widthFix"></image>
			</view>
			<view>
				...
				<text v-if="isEnable != '否'" class="twolist-hidden" style="height: 76upx;font-size: 28upx;margin-right: 8upx;margin-left: 8upx;max-lines:2;overflow: hidden">
					...
					<text
						v-else-if="logo == '../../static/img/ziying.png'"
						style="color: #FFFFFF;background: #FF2638;font-size: 20upx;padding-left: 12upx;padding-right: 12upx;border-radius: 12upx;margin-right: 8upx;padding-top: 4upx;padding-bottom: 4upx;"
					>
						自营
					</text>
				...
				<view>
					<view style="display: flex;margin-top: 5upx;">
						<view v-if="couponmoney!=null" style="background-color: #F7A746;width: 120upx;height: 40upx;margin-top:12upx;margin-bottom: 10upx;border-radius: 10upx;margin-left: 10upx;" >
							<text v-if="couponmoney!=null" style="font-size: 24upx;color:#FFFFFF;text-align: center;display: block;line-height: 40upx;">
								{{couponmoney}}元券
							</text>
						</view>
						<view v-if="isEnable != '否' && tkmoney" style="border-radius: 10upx;background-color: #F7A746;width: max-content;height: 40upx;display: flex;color: white;font-size: 20upx;margin-top: 12upx;margin-left: 14upx;">
							<text style="font-size: 24upx;color:#FFFFFF;text-align: center;display: block;line-height: 40upx;padding: 0upx 15upx;">返￥{{ tkmoney }}</text>
						</view>
					</view>
					<view style="display: flex;margin-left: 10upx;">
						<view style="width: 50%;margin-bottom: 4upx;font-size: 28upx;color: #E20C0A;padding-top: 4upx;text-align: left;margin-top:6upx;margin-right: 0;">
