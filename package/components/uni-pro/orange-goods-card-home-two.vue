	...
	<view style="background-color: #fff;">
		<view @click="open(itemid)" class="itemInfo1" v-bind:key="itemid">
			<view class="img_wrap" style="position: relative">
				<image :src="itempic" style="border-radius: 10upx;height: 200upx;" lazy-load="true" fade-show="true"></image>
			</view>
			<text class="twolist-hidden"
				style="height: 80upx;font-size: 28upx;margin-right: 8upx;margin-left: 8upx;max-lines:2;">
				<text
					style="overflow: hidden;-o-text-overflow: ellipsis;text-overflow: ellipsis;white-space: nowrap;display: block;">{{ itemtitle }}</text>
			</text>
			<view>
				<view style="display: flex;margin-left: 10upx;">
					<view
						style="width: 40%;margin-bottom: 4upx;font-size: 28upx;color: #E20C0A;padding-top: 4upx;text-align: left;margin-top:6upx;margin-right: 0;">
						<text style="font-size: 28upx;margin-right: 4upx">¥</text>
						<text style="text-align: left;font-weight: bold">{{ itemendprice }}</text>
					</view>

					<view
						style="font-size: 22upx;margin-top: 8upx;margin-left:16upx;color: grey; text-overflow: ellipsis;overflow: hidden;float: right;">
						{{ itemsale }}
					</view>
