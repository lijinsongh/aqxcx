	...
	<view>
		<view style="margin: 20upx 15upx;border-radius: 15upx;background-color: #FFFFFF;">
			<view style="padding: 20rpx 0 0 30rpx;color: #666666;font-size: 24rpx;display: flex;">
				...
				<urate style="margin-left: 15rpx;margin-top: 30rpx;" :size='14' :value="count1" />
				<!-- #endif -->
				<!-- #ifndef MP-WEIXIN -->
				<view style="margin-left: 10rpx;margin-top: 10rpx;">{{count1 > 0 ? count1 : '无'}}</view>
				<urate style="margin-left: 15rpx;margin-top: 12rpx;" :size='14' :value="count1" />
				<!-- #endif -->
			</view>
			...
			<view style="width: 100%;padding:20upx 0upx 20upx 20upx;" v-for="(ping,index) in pinglunList" v-if="pinglunList && pinglunList.length > 0">
				<view style="display: flex;padding: 20rpx;">
					<image :src="ping.userHeader ? ping.userHeader : '/static/logo2.png'" style="width: 80rpx;height: 80rpx;border-radius: 50rpx;"></image>
					<view style="margin-top: 5rpx;margin-left: 10rpx;width: 40%;">
						...
						<urate style="margin-left: 15rpx;margin-top: 10rpx;" :size='18' :value="ping.score" />
					</view>
				...
				<view style="display: flex;padding: 10rpx 0 0 10rpx;flex-wrap: wrap;" v-if="ping.img && ping.img.length > 0">
			...
			<!-- 加载更多提示 -->
			<view class="s-col is-col-24" v-if="pinglunList && pinglunList.length > 0">
