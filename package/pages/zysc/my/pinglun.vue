	...
	<view>
		<view style="width: 95%;height: 180upx;background: #FFFFFF; border-radius: 20upx;padding: 20upx;margin: 20upx;">
			<view style="display: flex;margin: 15upx 0 0 20upx;">
				...
				<view style="margin-left: 20upx;width: 75%;">
					<view style="font-size: 34upx;color: #FF332F;font-weight: bold;margin-top: 10upx;">¥ {{list.price}}
					</view>
					<view
						style="width: 100%;margin-top: 10upx;font-size: 28upx;color: #333333;font-weight: 500;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
						{{list.title}}</view>
				</view>
			</view>
		</view>
		<view style="background: #FFFFFF;padding: 20upx;margin: 20upx;width: 95%;border-radius: 20rpx;">
			...
			<view class="orang-view">
				<view><textarea placeholder="写出您的感受，可以帮助更多小伙伴哦~" v-model="content"
						style="color: #999999;font-size: 26rpx;width: 100%;" /></view>
			</view>
			<view class="header-ping">
				<view class="quanbu2" style="font-weight: bold;">
					服务评分
				</view>
				<!-- <view class="feedback-star-view"> -->
					<!-- <text class="feedback-star" style="font-size: 42upx;" v-for="(value, key) in stars" :key="key"
						:class="key < score ? 'active' : ''" @tap="chooseStar(value)"></text> -->
					<urate style="margin-top: 20rpx;" :size='18' :readonly="false" @change="chooseStar" :value='0'/>
				<!-- </view> -->
				<view
					style="color: #999999;font-size: 28upx;text-align: right;margin-left: 20upx;width: 24%;">{{evaluate}}</view>
			</view>
	...
	export default {
		...
		methods: {
			...
			addPinglun() {
				...
				if (this.$queue.getPinLunKeys(this.content) != -1) {
					uni.showToast({
						title: "评论内容带有非法关键字请重新输入",
						mask: false,
						duration: 1500,
						icon: "none"
					});
