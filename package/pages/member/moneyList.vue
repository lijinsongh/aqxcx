			...
			<view>
				...
				<view style="color: #000000;font-size: 28upx;">
					...
					<view style="margin-bottom: 8upx;text-align: right;">
						<!-- 提现金额： -->
						<text v-if="item.type==2" style="color: #FF2638;font-size: 32upx;font-weight: 600">￥ - {{item.money}}</text>
						<text v-if="item.type==1" style="color: #FF2638;font-size: 32upx;font-weight: 600">￥ + {{item.money}}</text>
					</view>
				</view>
