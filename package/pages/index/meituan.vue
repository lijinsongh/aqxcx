<template>
	<view style="padding-bottom: 50upx;">
		<image @tap="goBack" src="../static/indexc/loeft.png" class="left_view"></image>
		<image src="../static/indexc/topview2.png" class="top_view_image"></image>
		<view class="center_view">
			<image src="../static/indexc/meituanjianbian.png" class="center_view_backgroundImage"></image>
			<view class="center_view_item">
				<view style="display: flex;">
					<image src="../static/indexc/meituanlogo.png" class="logo"></image>
				...
				<view class="youhui_view">
					<image src="../static/indexc/youhuijuan.png" class="youhui_image"></image>
	...
	export default {
		...
		methods: {
			...
			getUrl() {
				...
				this.$Request.getT('/order/getMtUrls?relationId=' + relation_id + '&activityId=' + this.activityId +
					'&linkType=4').then(res => {
					if (res.status === 0) {
						this.url = res.data;
					} else {
