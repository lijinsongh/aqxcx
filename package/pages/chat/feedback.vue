	...
	<view class="page" style="background: #FFFFFF;">
		...
		<!-- <view class="feedback-title feedback-star-view">
			...
			<view class="feedback-star-view">
				<text class="feedback-star" v-for="(value, key) in stars" :key="key"
					:class="key < sendDate.score ? 'active' : ''" @tap="chooseStar(value)"></text>
			</view>
		</view> -->
		<button type="primary" style="background: #FF2638" class="feedback-submit" @tap="send">提交</button>
	</view>
</template>
